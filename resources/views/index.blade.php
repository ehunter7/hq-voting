<x-app-layout>
    ...
    <div class="ideas-container space-y-6 my-6">
        <div class="idea-container hover:shadow-md  cursor-pointer transition duration-150 ease-in bg-white rounded-xl flex">
        ...
        <div class="idea-container hover:shadow-md  cursor-pointer transition duration-150 ease-in bg-white rounded-xl flex">
            <div class="border-r border-gray-100 px-5 py-8">
                ...
                <div class="mt-8">
                    <button class="w-20 bg-cyan-700 text-white border border-white hover:border-cyan-900 transition duration-150 ease-in font-bold text-xs uppercase rounded-xl px-4 py-3">Voted</button>
                </div>
            </div>
                ...
                <div class="mx-4">
                    ...
                    <div class="flex items-center justify-between mt-6">
                        ...
                        <div class="flex items-center space-x-2">
                            <div class="bg-amber-400 text-white text-xs font-bold uppercase leading-none rounded-full text-center w-28 h-7 py-2 px-4">
                                In Progress</div>
        ...
        <div class="idea-container hover:shadow-md  cursor-pointer transition duration-150 ease-in bg-white rounded-xl flex">
            <div class="border-r border-gray-100 px-5 py-8">
                ...
                <div class="mt-8">
                    <button class="w-20 bg-gray-200 border border-blue-200 hover:border-blue-400 transition duration-150 ease-in font-bold text-xs uppercase rounded-xl px-4 py-3">Vote</button>
                </div>
            </div>
            <div class="flex px-2 py-6">
        ...
        <div class="idea-container hover:shadow-md  cursor-pointer transition duration-150 ease-in bg-white rounded-xl flex">
            ...
            <div class="flex px-2 py-6">
                <a href="#" class="flex-none"><img src="https://source.unsplash.com/200x200/?face&crop=face&v=4" alt="avatar" class="w-14 h-14 rounded-xl"></a>
                <div class="mx-4">
                    <h4 class="text-xl font-semibold"><a href="#" class="hover:underline">A random title can go
                            here</a></h4>
                    <div class="text-gray-600 mt-3 line-clamp-3">Lorem ipsum dolor sit amet consectetur, adipisicing
        ...
        <div class="idea-container hover:shadow-md  cursor-pointer transition duration-150 ease-in bg-white rounded-xl flex">
            ...
            <div class="flex px-2 py-6">
                <a href="#" class="flex-none"><img src="https://source.unsplash.com/200x200/?face&crop=face&v=5" alt="avatar" class="w-14 h-14 rounded-xl"></a>
                <div class="mx-4">
                    <h4 class="text-xl font-semibold"><a href="#" class="hover:underline">A random title can go
                            here</a></h4>
                    <div class="text-gray-600 mt-3 line-clamp-3">Lorem ipsum dolor sit amet consectetur, adipisicing
